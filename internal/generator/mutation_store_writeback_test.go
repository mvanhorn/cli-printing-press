...
func TestMutationCommandWritesSuccessfulResponseToStore(t *testing.T) {
	...
	data, _, err := resolveLocal(context.Background(), "items", true, "/items", nil, "test")
	if err != nil {
...
func TestPromotedMutationCommandWritesSuccessfulResponseToStore(t *testing.T) {
	...
	data, _, err := resolveLocal(context.Background(), "widgets", true, "/widgets", nil, "test")
	if err != nil {
...
func TestPromotedMutationCommandSkipsPartialFailureWriteBack(t *testing.T) {
	...
	if _, _, err := resolveLocal(context.Background(), "widgets", true, "/widgets", nil, "test"); err == nil {
...
func TestMutationCommandDryRunDoesNotWriteToStore(t *testing.T) {
	...
	if _, _, err := resolveLocal(context.Background(), "items", true, "/items", nil, "test"); err == nil {
