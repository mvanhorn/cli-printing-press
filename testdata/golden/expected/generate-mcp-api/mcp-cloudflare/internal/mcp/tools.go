...
func mcpPartialStoreNextStep() string {
	return "The latest sync attempt is incomplete. Resume or rerun mcp-cloudflare-pp-cli sync before treating local search/sql results as a complete snapshot."
}
