...
func newPublicPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "public.get-status", "pp:method": "GET", "pp:path": "/v1/public/status", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, status, prov, err = resolveRead(cmd.Context(), c, flags, "public", false, path, params, nil)
			_ = status
			if err != nil {
