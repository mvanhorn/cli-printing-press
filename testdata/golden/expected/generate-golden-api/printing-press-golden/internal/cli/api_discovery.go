...
Run 'api <interface>' to see that interface's methods.`,
  ...
  printing-press-golden-pp-cli api <interface-name>`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Build a typed slice once, used by both the human format loop
			// and the JSON envelope. Pre-formatting strings ahead of time
			// would block the JSON path from emitting clean field values.
