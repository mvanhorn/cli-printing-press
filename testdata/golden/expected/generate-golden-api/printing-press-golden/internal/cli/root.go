...
// pre-RunE usage-error shapes. Detection is by message prefix/substring
// to match the same approach the unknown-flag hint path uses above;
...
//   - "invalid argument \"x\" for ..."  (pflag, parse failure)
//
