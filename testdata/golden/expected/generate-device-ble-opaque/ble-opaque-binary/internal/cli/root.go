...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:          "ble-opaque-binary-pp-cli",
		Short:        "Control BLE Opaque Binary Device over BLE",
		Long:         "Control BLE Opaque Binary Device over BLE using a generated device-native CLI surface.",
		SilenceUsage: true,
	}
