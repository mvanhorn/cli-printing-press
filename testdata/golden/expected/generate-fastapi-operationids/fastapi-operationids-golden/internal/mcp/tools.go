...
func mcpPartialStoreNextStep() string {
	return "The latest sync attempt is incomplete. Resume or rerun fastapi-operationids-golden-pp-cli sync before treating local search/sql results as a complete snapshot."
}
