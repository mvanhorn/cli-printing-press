...
const (
	journalSessionEnvVar   = "LEARN_LOOP_EXAMPLE_LEARN_SESSION"
	journalNoLearnEnvVar   = "LEARN_LOOP_EXAMPLE_NO_LEARN"
	journalNoCaptureEnvVar = "LEARN_LOOP_EXAMPLE_LEARN_NO_CAPTURE"
)
