...
func newCustomersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "customers.get", "pp:method": "GET", "pp:path": "/v1/customers/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, status, prov, err = resolveRead(cmd.Context(), c, flags, "customers", false, path, params, nil)
			if err != nil {
