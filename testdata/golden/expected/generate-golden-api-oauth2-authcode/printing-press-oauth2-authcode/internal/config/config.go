...
type Config struct {
	...
	PrintingPressOauth2Oauth2AuthCode string          `toml:"press_oauth2_oauth2_auth_code"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://api.authcode.example/v1",
	}
	...
	// Env var overrides
	if v := cliutil.EnvOverride("PRINTING_PRESS_OAUTH2_OAUTH2_AUTH_CODE"); v != "" {
		cfg.PrintingPressOauth2Oauth2AuthCode = v
		cfg.markEnvOverride("PrintingPressOauth2Oauth2AuthCode")
		cfg.AuthSource = "env:PRINTING_PRESS_OAUTH2_OAUTH2_AUTH_CODE"
		cfg.CredentialSource = "env:PRINTING_PRESS_OAUTH2_OAUTH2_AUTH_CODE"
	}
	...
	if v := cliutil.EnvOverride("PRINTING_PRESS_OAUTH2_AUTHORIZATION_URL"); v != "" {
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in PRINTING_PRESS_OAUTH2_OAUTH2_AUTH_CODE (a pasted access token, or a
	...
	if c.PrintingPressOauth2Oauth2AuthCode != "" {
		return "Bearer " + c.PrintingPressOauth2Oauth2AuthCode
	}
	return ""
}
...
func (c *Config) StoreScopeCredential() string {
	...
	if c.PrintingPressOauth2Oauth2AuthCode != "" {
		parts = append(parts, "press_oauth2_oauth2_auth_code="+c.PrintingPressOauth2Oauth2AuthCode)
	}
	if len(parts) == 0 {
		return ""
	}
...
func (c *Config) clearCredentialFields() {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.PrintingPressOauth2Oauth2AuthCode = ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		PrintingPressOauth2Oauth2AuthCode: c.PrintingPressOauth2Oauth2AuthCode,
	}
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.PrintingPressOauth2Oauth2AuthCode = ""
	delete(c.envOverrides, "PrintingPressOauth2Oauth2AuthCode")
	c.updateFileConfigField("PrintingPressOauth2Oauth2AuthCode")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["PrintingPressOauth2Oauth2AuthCode"] {
			out.PrintingPressOauth2Oauth2AuthCode = c.fileConfig.PrintingPressOauth2Oauth2AuthCode
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "PrintingPressOauth2Oauth2AuthCode":
		c.fileConfig.PrintingPressOauth2Oauth2AuthCode = c.PrintingPressOauth2Oauth2AuthCode
	}
}
