...
2. **Structured output**: `--json` produces valid JSON, `--select` filters fields correctly. See principle 11 for the helper hand-written novel commands must use.
