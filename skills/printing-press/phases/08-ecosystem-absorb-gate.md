...
4. `command` must match the actual CLI subcommand that will be built in [Phase 3](11-build-the-goat.md). For subcommands of a resource (e.g., `issues stale`), use the full command path.
