...
**Scope:** Phase 1 detectors are shape-only — card-last-4, email, US phone, ZIP+4, postal-address. Order/transaction IDs, ASINs, and standalone names are deferred to [#960](https://github.com/mvanhorn/cli-printing-press/issues/960). A passing gate is the floor, not "PII-clean."
